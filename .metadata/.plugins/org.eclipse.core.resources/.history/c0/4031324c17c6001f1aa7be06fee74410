...
#define CLCK_SELECT  Divide_by_8
 ...
 * */
#define TIMER1A_MODE  TIMER1_FAST_PWM

#define TIMER1B_MODE  TIMER1_FAST_PWM
...
#define TIMER1A_OUT_MODE  PWM_CLEAR_COMPARE_SET_TOP

#define TIMER1B_OUT_MODE  PWM_CLEAR_COMPARE_SET_TOP
